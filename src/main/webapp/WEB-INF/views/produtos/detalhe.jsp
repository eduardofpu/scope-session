...
<head>
	...
	<link rel="icon" href="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/favicon.png?14078348787656721002" type="image/png"/>
...
<title>${produto.titulo} - Casa do Código</title>
    ...
    <meta property="og:title" content="Livro de Java 8 - Casa do Código"/>


	
    <meta property="og:description" content="Conceitos simples mas que trazem importantes possibilidades. Durante o livro exploraremos diversos avan&#231;os do Java 8. Sempre com exemplos pr&#225;ticos e apresentando onde utiliz&#225;-los, migrando o c&#243;digo legado do dia a dia para o novo paradigma funcional do Java 8."/>
    ...
    <meta property="og:url" content="https://www.casadocodigo.com.br/products/livro-java8"/>


	
    
      <meta property="og:image" content="http://cdn.shopify.com/s/files/1/0155/7645/products/java8-socialmedia_large.png?v=1411490181" />
    


	
    <meta itemprop="name" content="Livro de Java 8 - Casa do Código">


	
	<meta name="description" content="Conceitos simples mas que trazem importantes possibilidades. Durante o livro exploraremos diversos avan&#231;os do Java 8. Sempre com exemplos pr&#225;ticos e apresentando onde utiliz&#225;-los, migrando o c&#243;digo legado do dia a dia para o novo paradigma funcional do Java 8.">


	<meta itemprop="image" content="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/casa-do-codigo.svg?14078348787656721002">
...
<meta id="in-context-paypal-metadata" data-shop-id="1557645" data-environment="production" data-locale="pt_BR" data-merchant-id="7LDYBY8GYBXGU" data-redirect-url="" />
	...
	<!-- inject:css -->
	<link rel="stylesheet" href="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/style.css?14078348787656721002">
	<!-- endinject -->
	...
	<div id="navegacaoCabecalho" class="cabecalhoPrincipal-navegacao">
		...
		<a tabindex="3" href="/cart" title="Ir para sacola de compras" class="sacola cabecalhoPrincipal-itemNavegacao">
			<svg width="60px" height="24px" viewBox="0 0 60 24" role="img" aria-labelledby="sacolaLabel" class="sacola-icone">
				...
				<g>
					...
					<text text-decoration="none" text-anchor="middle" x="13.148581" y="19" 
		...
		<a tabindex="2" class="cabecalhoPrincipal-itemNavegacao cabecalhoPrincipal-mostraCategoriasEBusca" href="#navegacaoCabecalho">
			<img class="cabecalhoPrincipal-iconeItemNavegacao"
				 src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/hamburguer.svg?14078348787656721002"
	...
	<div class="cabecalhoProdutoLivro-tituloEAutor">
		<h1 itemprop="name" class="cabecalhoProdutoLivro-titulo">
			<span class="cabecalhoProdutoLivro-titulo-principal" role="presentation">
				<h1 class="product-title" itemscope="name">${produto.titulo}</h1>
			</span>
			<span class="cabecalhoProdutoLivro-titulo-sub" role="presentation">
				 <h1 class="book-description" itemscope="description">${produto.descricao}</h1>
			</span>
		</h1>
...
<form action='<c:url value ="/carrinho/add" />' method="POST" class="adicionarAoCarrinho">
	<ul class="adicionarAoCarrinho-listaOfertas">
			...
			<label class="adicionarAoCarrinho-infosDaOferta" >
				...
				>
					<span class="adicionarAoCarrinho-tipoDaOferta-nome">
						<h1 class="product-title" itemscope="name"> ${preco.tipo}</h1>
					</span>
				...
				<p class="adicionarAoCarrinho-preco">
						...
						<small class="adicionarAoCarrinho-preco-promocao">
							<del class="adicionarAoCarrinho-preco-promocao-valor"><p class="variant-price">R$ ${preco.valor}</p></del> 
						</small>
				...
				<button class="adicionarAoCarrinho-botaoComprar" type="submit" name="tipo" value="${preco.tipo}" title="Compre o E-book '${produto.titulo}'!" >
					Comprar
				</button>
	  ...
	  <p>Número de Páginas: <span class="adicionarAoCarrinho-tipoDaOferta-nome">${produto.paginas}</span></p>				
	...
	<script type="text/javascript" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/trackExternalLinks.js?14078348787656721002"></script>
	
	<script type="text/javascript" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/userreport.js?14078348787656721002"></script>
	<script type="text/javascript" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/discount.js?14078348787656721002"></script>
	<script type="text/javascript" src="//cdn.shopify.com/s/files/1/0155/7645/t/229/assets/menu.js?14078348787656721002"></script>
</body>
</html>